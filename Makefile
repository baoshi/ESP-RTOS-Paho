...
SDK_BASE	?= c:/Espressif/ESP8266_RTOS_SDK_1.3
...
MODULES		= driver user paho
EXTRA_INCDIR    = include 

# libraries used in this project, mainly provided by the SDK
LIBS		= gcc hal phy pp net80211 wpa main freertos lwip minic crypto

# compiler flags using during compilation of source files
CFLAGS		= -Os -g -Os -Wpointer-arith -Wundef -Werror -Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals -ffunction-sections -fdata-sections -D__ets__ -DICACHE_FLASH
