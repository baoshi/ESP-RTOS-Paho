...
/*----------------------------------------------*/
/*  xfprintf(..., "%d", 1234);            "1234"
    xfprintf(..., "%6d,%3d%%", -200, 5);  "  -200,  5%"
    xfprintf(..., "%-6u", 100);           "100   "
    xfprintf(..., "%ld", 12345678L);      "12345678"
    xfprintf(..., "%04x", 0xA3);          "00a3"
    xfprintf(..., "%08LX", 0x123ABC);     "00123ABC"
    xfprintf(..., "%016b", 0x550F);       "0101010100001111"
    xfprintf(..., "%s", "String");        "String"
    xfprintf(..., "%-4s", "abc");         "abc "
    xfprintf(..., "%4s", "abc");          " abc"
    xfprintf(..., "%c", 'a');             "a"
*/
